...
urlpatterns = [
    ...
    path('esqueci-senha/enviado/', senha_redefinicao_enviada, name='senha_redefinicao_enviada'),
    path('redefinir-senha/<uidb64>/<token>/', redefinir_senha, name='redefinir_senha'),
    path('redefinir-senha/sucesso/', senha_redefinida_sucesso, name='senha_redefinida_sucesso'),
    ...
    path('api/cafeterias/', views.api_cafeterias, name='api_cafeterias'),
    path('api/minhas-reservas/', views.api_minhas_reservas, name='api_minhas_reservas'),
